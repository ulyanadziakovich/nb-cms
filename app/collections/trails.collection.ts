...
export default defineCollection({
  ...
  fields: {
    ...
    routeMapImage: { type: 'image', options: { required: false, label: 'Mapa przebiegu trasy' } },
    elevationProfileImage: { type: 'image', options: { required: false, label: 'Profil wysokościowy' } },
